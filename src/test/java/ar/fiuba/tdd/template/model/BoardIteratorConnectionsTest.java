...
public class BoardIteratorConnectionsTest {
    ...
    public void insertValidMovement_returnTrue() {
        Assert.assertTrue(iterator.validateDirection(board, board.getCell(2, 2), UP));
    }

    @Test
    public void insertRightValidMovement_returnFalse() {
        Assert.assertTrue(!iterator.validateDirection(board, board.getCell(2, 3), RIGHT));
    }

    @Test
    public void insertLeftValidMovement_returnFalse() {
        Assert.assertTrue(!iterator.validateDirection(board, board.getCell(2, 0), LEFT));
    }

    @Test
    public void insertDownValidMovement_returnFalse() {
        Assert.assertTrue(!iterator.validateDirection(board, board.getCell(3, 2), DOWN));
    }

    @Test
    public void insertUpValidMovement_returnFalse() {
        Assert.assertTrue(!iterator.validateDirection(board, board.getCell(0, 3), UP));
    }
}
