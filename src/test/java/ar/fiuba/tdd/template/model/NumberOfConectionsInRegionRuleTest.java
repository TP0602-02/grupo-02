...
public class NumberOfConectionsInRegionRuleTest {
    ...
    public void setUp() {
        ...
        cells.add(this.board.getCell(0, 1));
        cells.add(this.board.getCell(0, 2));
        cells.add(this.board.getCell(1, 0));
        cells.add(this.board.getCell(1, 1));
        cells.add(this.board.getCell(1, 2));
        cells.add(this.board.getCell(2, 0));
        cells.add(this.board.getCell(2, 1));
        cells.add(this.board.getCell(2, 2));
    ...
    public void addConectionInSameRegionWithTwoValues_ReturnFalse() {
        this.board.setValue(2, 2, new ValueContent(RIGHT));
        this.board.setValue(2, 3, new ValueContent(LEFT));
        this.board.setValue(1, 2, new ValueContent(RIGHT));
        this.board.setValue(1, 3, new ValueContent(LEFT));
        Assert.assertTrue(!this.rule.validate(this.board, this.board.getCell(0, 0), RIGHT));
    }
    ...
    public void addConectionInOtherRegionWithTwoValues_ReturnTrue() {
        ...
        this.board.setValue(1, 3, new ValueContent(LEFT));
        ArrayList<Cell> cells = new ArrayList<Cell>();
        cells.add(this.board.getCell(3, 0));
        this.board.addRegion(new Region(cells));
        Assert.assertTrue(this.rule.validate(this.board, this.board.getCell(2, 0), DOWN));
    }
    ...
    public void addConectionInOtherRegionWithThreeValues_ReturnTrue() {
        ...
        this.board.setValue(0, 3, new ValueContent(LEFT));
        ArrayList<Cell> cells = new ArrayList<Cell>();
        cells.add(this.board.getCell(3, 0));
        this.board.addRegion(new Region(cells));
        Assert.assertTrue(!this.rule.validate(this.board, this.board.getCell(2, 0), DOWN));
